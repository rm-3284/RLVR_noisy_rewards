...
# Gate the policy-worker executables on the same flag so air-gapped Della runs (where a runtime
# `uv sync` can't reach the network) use the single prebuilt base venv for every worker.
FSDP_EXECUTABLE = (
...
ACTOR_ENVIRONMENT_REGISTRY: dict[str, str] = {
    ...
    "nemo_rl.environments.code_verifier_environment.CodeVerifierEnvironment": PY_EXECUTABLES.SYSTEM,
    "nemo_rl.environments.code_verifier_environment.CodeVerifyWorker": PY_EXECUTABLES.SYSTEM,
